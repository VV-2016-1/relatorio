...
Esse software pode ser acessado no seguinte \hypertarget{tem-df}{endereço}
\hyperlink{tem-df}{https://github.com/EscalaSaudeDF/TEM-DF}
...
\begin{itemize}
    \item Travis \url{ https://docs.travis-ci.com/}
    \item Estudo de Caso
\end{itemize}
